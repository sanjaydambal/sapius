...
const Footer = () => {
  return (
    ...
    <img src="/assets/sapius_logo.png" alt="Sapius Logo" className="h-8 w-auto" />
          ...
          <p className="text-gray-400 text-sm mt-6 ">Reach out to us for queries at </p>
          <br/>
          <p className="text-gray-600 text-sm mt-0"> <a href="mailto:info@sapius.ai" className="text-blue-500 hover:underline">info@sapius.ai</a></p>
...
>
  LinkedIn
        ...
        <div className='ml-20'>
            <h3 className="text-gray-700 text-sm font-medium mb-2 mt-0">Support</h3>
          ...
          <div className='ml-20'>
            <h3 className="text-gray-700 text-sm font-medium mb-2 ">Company</h3>
            <ul className="space-y-2">
          ...
          <div className='ml-20'>
            <h3 className="text-gray-700 text-sm font-medium mb-2 ">Services</h3>
            <ul className="space-y-2">
