  ...
  return (
    <div className="bg-white py-12 relative">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center">
        {/* Image Section */}
        <div className="md:w-1/2 flex justify-center relative z-10"> {/* Add z-10 to bring the image to the front */}
          <img
        ...
        <div className="md:w-1/2 mt-8 md:mt-0" style={{ paddingLeft: '20px' }}>
          ...
          <p className="text-gray-600 text-justify mb-1 text-center md:text-left" style={{ width: '400px', height: '85px' }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed eiusmod tempor
            vhgvncncb bn nbvnbvnbvnbvn
          </p>
          <p className="text-gray-600 text-justify text-center md:text-left mt-2" style={{ width: '400px', height: '210px' }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed eiusmod tempor
      ...
      <div 
        style={{
          ...
          position: 'absolute',
          bottom: 0,
          zIndex: 1, // Send this background behind
